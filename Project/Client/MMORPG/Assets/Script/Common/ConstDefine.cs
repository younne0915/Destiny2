...
public class ConstDefine
{
    ...
    public const string SelectRole_BeginGame = "SelectRole_BeginGame";
    public const string SelectRole_DeleteRole = "SelectRole_DeleteRole";
    public const string SelectRole_Return = "SelectRole_Return";
    public const string SelectRole_CreateRole = "SelectRole_CreateRole";
