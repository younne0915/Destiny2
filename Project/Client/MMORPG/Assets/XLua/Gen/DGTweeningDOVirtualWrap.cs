...
namespace XLua.CSObjectWrap
{
    ...
    public class DGTweeningDOVirtualWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(DG.Tweening.DOVirtual), L, translator, 0, 0, 0, 0);
			
			
			
			
			
			Utils.EndObjectRegister(typeof(DG.Tweening.DOVirtual), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(DG.Tweening.DOVirtual), L, __CreateInstance, 4, 0, 0);
            ...
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(DG.Tweening.DOVirtual));
			
			
			Utils.EndClassRegister(typeof(DG.Tweening.DOVirtual), L, translator);
        }
