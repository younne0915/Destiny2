...
namespace XLua.CSObjectWrap
{
    ...
    public class Coroutine_RunnerWrap
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			Utils.BeginObjectRegister(typeof(Coroutine_Runner), L, translator, 0, 1, 0, 0);
			...
			Utils.EndObjectRegister(typeof(Coroutine_Runner), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(Coroutine_Runner), L, __CreateInstance, 1, 0, 0);
			
			
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(Coroutine_Runner));
			
			
			Utils.EndClassRegister(typeof(Coroutine_Runner), L, translator);
        }
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					Coroutine_Runner __cl_gen_ret = new Coroutine_Runner();
