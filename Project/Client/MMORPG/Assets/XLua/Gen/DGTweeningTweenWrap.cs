...
namespace XLua.CSObjectWrap
{
    ...
    public class DGTweeningTweenWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(DG.Tweening.Tween), L, translator, 0, 52, 7, 7);
			...
			Utils.EndObjectRegister(typeof(DG.Tweening.Tween), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(DG.Tweening.Tween), L, __CreateInstance, 1, 0, 0);
			
			
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(DG.Tweening.Tween));
			
			
			Utils.EndClassRegister(typeof(DG.Tweening.Tween), L, translator);
        }
