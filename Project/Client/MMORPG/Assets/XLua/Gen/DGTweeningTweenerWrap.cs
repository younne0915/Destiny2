...
namespace XLua.CSObjectWrap
{
    ...
    public class DGTweeningTweenerWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(DG.Tweening.Tweener), L, translator, 0, 26, 0, 0);
			...
			Utils.EndObjectRegister(typeof(DG.Tweening.Tweener), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(DG.Tweening.Tweener), L, __CreateInstance, 1, 0, 0);
			
			
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(DG.Tweening.Tweener));
			
			
			Utils.EndClassRegister(typeof(DG.Tweening.Tweener), L, translator);
        }
