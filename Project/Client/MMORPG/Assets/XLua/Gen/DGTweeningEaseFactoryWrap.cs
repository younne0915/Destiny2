...
namespace XLua.CSObjectWrap
{
    ...
    public class DGTweeningEaseFactoryWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(DG.Tweening.EaseFactory), L, translator, 0, 0, 0, 0);
			
			
			
			
			
			Utils.EndObjectRegister(typeof(DG.Tweening.EaseFactory), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(DG.Tweening.EaseFactory), L, __CreateInstance, 2, 0, 0);
			Utils.RegisterFunc(L, Utils.CLS_IDX, "StopMotion", _m_StopMotion_xlua_st_);
            
			
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(DG.Tweening.EaseFactory));
			
			
			Utils.EndClassRegister(typeof(DG.Tweening.EaseFactory), L, translator);
        }
