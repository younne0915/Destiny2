...
namespace XLua.CSObjectWrap
{
    ...
    public class SystemObjectWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(object), L, translator, 0, 4, 0, 0);
			...
			Utils.EndObjectRegister(typeof(object), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(object), L, __CreateInstance, 3, 0, 0);
            ...
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(object));
			
			
			Utils.EndClassRegister(typeof(object), L, translator);
        }
