...
namespace XLua.CSObjectWrap
{
    ...
    public class DGTweeningTweenParamsWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(DG.Tweening.TweenParams), L, translator, 0, 19, 0, 0);
			...
			Utils.EndObjectRegister(typeof(DG.Tweening.TweenParams), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(DG.Tweening.TweenParams), L, __CreateInstance, 2, 0, 0);
			
			
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "Params", DG.Tweening.TweenParams.Params);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(DG.Tweening.TweenParams));
			
			
			Utils.EndClassRegister(typeof(DG.Tweening.TweenParams), L, translator);
        }
