...
namespace XLua.CSObjectWrap
{
    ...
    public class DGTweeningDOTweenWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(DG.Tweening.DOTween), L, translator, 0, 0, 0, 0);
			
			
			
			
			
			Utils.EndObjectRegister(typeof(DG.Tweening.DOTween), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(DG.Tweening.DOTween), L, __CreateInstance, 42, 14, 14);
            ...
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(DG.Tweening.DOTween));
			...
			Utils.EndClassRegister(typeof(DG.Tweening.DOTween), L, translator);
        }
